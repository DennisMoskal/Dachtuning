        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, idx) => {
              ...
              return (
                <div key={idx} className="group bg-gradient-to-br from-zinc-900 to-black border border-zinc-800 rounded-lg overflow-hidden hover:border-orange-600 transition-all hover:shadow-xl flex flex-col">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <button className="w-full px-4 py-2 bg-orange-600 text-white text-xs uppercase font-bold tracking-wider hover:bg-orange-700 transition-colors rounded mt-auto">
                      Mehr Erfahren
                    </button>
                  </div>
                </div>
      ...
      <footer className="bg-black border-t-4 border-orange-600">
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="flex flex-col items-center justify-center mb-12 pb-12 border-b border-zinc-800">
            ...
            <h3 className="text-2xl text-white font-bold text-center">Dachtuning.de</h3>
            <p className="text-zinc-400 text-xs mt-2 font-mono uppercase tracking-widest">Professionelle Dachsanierung seit 1999</p>
          </div>
